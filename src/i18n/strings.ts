...
export const STRINGS = {
  ar: {
    ...
    circ_success_sub: 'الموقع يُعاد بناؤه. ستظهر الوثيقة خلال ١–٣ دقائق.',
  ...
  en: {
    ...
    nav_circulars: 'Circulars & Decisions',
    ...
    circ_success_sub: 'Site is rebuilding. The document will appear in 1–3 minutes.',
