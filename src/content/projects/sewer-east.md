...
"updates":
  - "date":
    ...
    "author":
      ...
      "en": "رئيس البلدية"
    "body":
      "ar": "التبرعات تُحفظ في متصفحك فقط — للعرض التجريبيالتبرعات تُحفظ في متصفحك فقط — للعرض التجريبيالتبرعات تُحفظ في متصفحك فقط — للعرض التجريبيالتبرعات تُحفظ في متصفحك فقط — للعرض التجريبيالتبرعات تُحفظ في متصفحك فقط — للعرض التجريبيالتبرعات تُحفظ في متصفحك فقط — للعرض التجريبيالتبرعات تُحفظ في متصفحك فقط — للعرض التجريبيالتبرعات تُحفظ في متصفحك فقط — للعرض التجريبيالتبرعات تُحفظ في متصفحك فقط — للعرض التجريبي"
      "en": ""
  - "date":
      "ar": "منذ ٦ أيام"
      "en": "6 days ago"
...
"comments":
  - "author":
      ...
      "en": "رئيس البلدية"
    "body":
      "ar": "التبرعات تُحفظ في متصفحك فقط — للعرض التجريبيالتبرعات تُحفظ في متصفحك فقط — للعرض التجريبيالتبرعات تُحفظ في متصفحك فقط — للعرض التجريبيالتبرعات تُحفظ في متصفحك فقط — للعرض التجريبي"
      "en": ""
    "date": "2026-07-02"
---
